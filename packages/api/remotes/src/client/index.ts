...
import embymediaRemote from '@embymedia/dsh-operations/remote'
...
export type {} from '@embymedia/dsh-operations/remote'
...
export async function apply(ctx: Context): Promise<() => Promise<void>> {
  ...
  try {
    for (const contribution of [
      ...
      subagentsRemote, sessionRemote, workspaceRemote, embymediaRemote,
    ]) {
