...
func (d *DB) migrate() error {
	...
	CREATE TABLE IF NOT EXISTS cross_drive_imports (
		...
		autofill_library_name TEXT,
		autofill_library_id TEXT,
		autofill_library_cid TEXT,
		autofill_series_id TEXT,
		autofill_tmdb_id TEXT,
		autofill_series_folder TEXT,
	...
	for _, migration := range []struct{ table, column, definition string }{
		...
		{"cross_drive_imports", "selected_source_ids", "TEXT NOT NULL DEFAULT '[]'"},
		{"cross_drive_imports", "autofill_library_name", "TEXT"},
		{"cross_drive_imports", "autofill_library_id", "TEXT"},
		{"cross_drive_imports", "autofill_library_cid", "TEXT"},
		{"cross_drive_imports", "autofill_series_id", "TEXT"},
		{"cross_drive_imports", "autofill_tmdb_id", "TEXT"},
		{"cross_drive_imports", "autofill_series_folder", "TEXT"},
		{"cross_drive_imports", "expected_episodes", "TEXT NOT NULL DEFAULT '[]'"},
	} {
